...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Send.Func.Test
{
    ...
    public class SendFunctionTest
    {
        ...
        public async Task SendNotificationWhenNoConversationIdTest()
        {
            ...
            notificationService.Verify(x => x.UpdateSentNotification(It.Is<string>(x=>x.Equals("notificationId")), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()));
        }
        ...
        public async Task SendNotificationSuccess_Test()
        {
            ...
            notificationService.Setup(x => x.UpdateSentNotification(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>())).Returns(Task.CompletedTask);
