...
import { duplicateDraftNotification, deleteSendNotification } from '../../apis/messageListApi';
import { selectMessage, getMessagesList, getDraftMessagesList, getSentMessagesList } from '../../actions';
...
class Overflow extends React.Component<OverflowProps, OverflowState> {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            onClick: (event: any) => {
                                ...
                                let url = getBaseUrl() + "/newmessage/" + this.props.message.id + "?locale={locale}&Notification=sent";
    ...
    private deleteSentMessage = async (id: number) => {
        try {
            await deleteSendNotification(id);
        } catch (error) {
            return error;
        }
    }
...
export default connect(mapStateToProps, { selectMessage, getMessagesList, getDraftMessagesList, getSentMessagesList })(overflowWithTranslation);
